...
public class ConsulRegistryTest {
    ...
    /*URL               registryUrl = URL.valueOf("consul://192.168.43.78:8500/");
    URL               serviceUrl  = URL.valueOf("consul://192.168.43.77:8088/" + service
                                                + "?notify=false&methods=test1,test2&version=1.0");*/
    URL               registryUrl = URL.valueOf("consul://192.168.177.129:8500/");
    URL               serviceUrl  = URL.valueOf("consul://192.168.177.1:8088/" + service
            + "?notify=false&methods=test1,test2&version=1.0");
   ...
   ConsulRegistry registry = new ConsulRegistry(registryUrl);
    ...
    public void getServices() throws Exception {
        registry.getServices(serviceUrl);
    }
    ...
    public void testURL(){
        ...
        System.out.println(serviceUrl.getServiceInterface()+Constants.PATH_SEPARATOR + serviceUrl.getParameter(Constants.CATEGORY_KEY, Constants.DEFAULT_CATEGORY));
